...
func (_Wbnb *WbnbTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Wbnb.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Wbnb *WbnbSession) Receive() (*types.Transaction, error) {
	return _Wbnb.Contract.Receive(&_Wbnb.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Wbnb *WbnbTransactorSession) Receive() (*types.Transaction, error) {
	return _Wbnb.Contract.Receive(&_Wbnb.TransactOpts)
}
